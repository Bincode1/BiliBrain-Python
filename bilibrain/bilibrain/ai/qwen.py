            ...
            (
                ...
                "\n".join(
                    [
                        ...
                        "",
                        "可选 route：",
                        "1. direct：不需要检索知识库，直接回答。",
                        "   - 追问前文、回顾刚才对话、闲聊、通用知识",
                        "2. kb_qa：需要检索知识库中的视频内容来回答。",
                        "",
                        "当 route=kb_qa 时，还需选择 retrieval_strategy：",
                        "- chunk：查具体细节、事实、步骤、定义、时间点",
                        "- summary：做总结、概括、归纳、对比、梳理整体观点",
                        "",
                        "硬约束：",
                        "1. route=kb_qa 时，回答必须严格受知识库范围约束。",
                        "2. 只在确实不需要知识库内容时才选 direct。",
                        "",
